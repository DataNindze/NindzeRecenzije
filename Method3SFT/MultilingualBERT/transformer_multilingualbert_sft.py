...
BASE_DIR = "/content/drive/MyDrive/Obrada_prirodnog_jezika (1)"

TRAIN_FILE = os.path.join(BASE_DIR, "data", "TRAIN.csv")
VALIDATION_FILE = os.path.join(BASE_DIR, "data", "VALIDATION.csv")

TEST_FILES = {
    "Test 1: group 1": os.path.join(BASE_DIR, "data", "test_1.xlsx"),
    "Test 2: group 2": os.path.join(BASE_DIR, "data", "test_2.xlsx"),
    "Test 3: group 3 (OURS)": os.path.join(BASE_DIR, "data", "test_3.csv"),
    "Test 4: group 4": os.path.join(BASE_DIR, "data", "test_4.tsv"),
}

MODEL_NAME = "bert-base-multilingual-cased"
MODEL_SHORT_NAME = "multilingual_bert"
...
for test_name, test_path in TEST_FILES.items():
    ...
    all_prediction_files.append(prediction_path)
...
content = f"""# Transformer Results - multilingual BERT
...
results_df.to_csv(
    os.path.join(BASE_DIR, "transformer_results_mbert.csv"),
    index=False,
    encoding="utf-8-sig",
    sep=";"
)
...
print()
print("Gotovo.")
print("Napravljen je results_transformers_mbert.md")
print("Napravljen je transformer_results_mbert.csv")
